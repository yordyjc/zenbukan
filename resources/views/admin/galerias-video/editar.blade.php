        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-block">
                    <form action="{{url('admin/galeria-videos/'.$galeria->id)}}" method="post" enctype="multipart/form-data">
                        @csrf  
                        @method('PUT')
                        <div class="col-sm-10 offset-sm-1">
                            ...
                            <div class="row form-group {{$errors->has('descripcion') ? 'has-danger': ''}}">
                                ...
                                <div class="col-md-10">
                                <textarea  rows="10" class="form-control {{ $errors->has('descripcion') ? ' form-control-danger' : '' }}" id="descripcion" name="descripcion">{{ $galeria->descripcion }}</textarea>
                            ...
                            <div class="form-group {{ $errors->has('foto') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    @endif
                                    <h6>Previsualización:</h6><img id="img-foto" src="{{ $galeria->foto ? $galeria->foto : '/resources/img/default.jpg' }}" style="width:300px;" alt="Previsualización" class="img-fluid">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 form-radio">
                                    <div class="radio radio-inline">
                                        <label>
                                        <input type="radio" name="estado" id="estado" value="1" {{ $galeria->estado == '1' ? 'checked' : '' }}>
                                        <i class="helper"></i> Habilitado
                                        </label>
                                    </div>
                                    <div class="radio radio-inline">
                                        <label>
                                        <input type="radio" name="estado" id="estado" value="0" {{ $galeria->estado == '0' ? 'checked' : '' }}>
