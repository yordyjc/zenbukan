...
@section('title')
Gestión de pases gratis
@endsection

@section('pases-gratis')
active
@endsection
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ Carbon::parse($pase->created_at)->format('d \d\e M, Y') }}
                                </td>
                                <td class="text-center">
                                    @if ($pase->estado == 0)
                                        <label class="label label-danger">No atendido</label>
                                    @else
                                        <label class="label label-success">Atendido</label>
                                    @endif
                                </td>
                                <td class="text-center">
                                    <a href="#" onclick="eliminarModal({{ $pase->id }})" data-toggle="modal" data-target="#eliminarModal">
                                        <i class="feather icon-check-circle f-w-600 f-16 text-c-green" data-toggle="tooltip" data-placement="left" data-original-title="Marcar como atendido"></i>
                                    </a>
                                </td>
                            </tr>
                            @endforeach
                                        ...
                                        <form action="" method="POST" id="form-modal">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-danger btn-round">
                                                    <i class="icofont icofont-ui-delete"></i> Sí, continuar
                                                </button>
