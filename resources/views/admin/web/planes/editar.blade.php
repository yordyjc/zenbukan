                ...
                <form action="{{ url('/admin/planes/'.$plan->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-10 offset-sm-1">
                        <div class="form-group {{ $errors->has('nombre') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control form-control-round {{ $errors->has('nombre') ? ' form-control-danger' : '' }}" id="nombre" name="nombre" value="{{ $plan->nombre }}">
                        ...
                        <div class="form-group {{ $errors->has('descripcion') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-10">
                                <textarea  rows="10" class="form-control {{ $errors->has('descripcion') ? ' form-control-danger' : '' }}" id="descripcion" name="descripcion">{{ $plan->descripcion }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('precio') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-3">
                                <select name="moneda" id="moneda" class="form-control form-control-round fill select2">
                                    <option value="S/" {{ $plan->moneda == 'S/' ? 'selected' : '' }}>Soles (S/)</option>
                                    <option value="US$" {{ $plan->moneda == 'US$' ? 'selected' : '' }}>Dólares (US$)</option>
                                </select>
                            </div>
                            <div class="col-md-7">
                                <input type="text" class="form-control form-control-round {{ $errors->has('precio') ? ' form-control-danger' : '' }}" id="precio" name="precio" value="{{ $plan->precio }}">
                        ...
                        <div class="form-group {{ $errors->has('color') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-10">
                                <input class="jscolor {hash:true} form-control form-control-round {{ $errors->has('color') ? ' form-control-danger' : '' }}" id="color" name="color" value="{{ $plan->color }}">
                                @if ($errors->has('color'))
                                <div class="col-form-label">
                                    {{ $errors->first('color') }}
                                </div>
