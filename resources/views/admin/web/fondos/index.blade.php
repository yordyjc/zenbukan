        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-right">
                    <a href="{{ url('/admin/fondos/create') }}" class="btn waves-effect waves-light btn-primary btn-outline-primary btn-sm"> <i class="icofont icofont-ui-add" style="color:#4680ff;"></i> Agregar imagen</a>
                </div>
            </div>
                    ...
                    <table id="fitnessTable" class="table table-striped table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ $fondo->foto }}" target="_blank">{{ $fondo->foto }}</a>
                                </td>
                                <td class="text-center">
                                    <a href="#" onclick="eliminarModal({{ $fondo->id }})" data-toggle="modal" data-target="#eliminarModal">
