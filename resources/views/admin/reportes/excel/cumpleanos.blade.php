...
<table border="1">
    <thead>
        <tr>
            <td colspan="8" align="center">REPORTE DE INSCRITOS QUE CUMPLEN AÑOS EN {{ $mes }}</td>
        </tr>
        <tr>
            <th>#</th>
            <th>Inscripción</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                Cumple {{ Carbon::parse($ficha->usuario->nacimiento)->age+1 }} años el {{ Carbon::parse($inscrito->nacimiento)->format('d \d\e M.') }}
            </td>
