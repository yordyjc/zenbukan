                ...
                <form action="{{ url('/admin/configuracion-general/'.$configuracion->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-10 offset-sm-1">
                        <div class="form-group {{ $errors->has('logo') ? ' has-danger' : '' }} row">
                            ...
                            <div class="col-md-10">
                                ...
                                @endif
                                <div class="col-form-label text-muted">Una imagen que será mostrada como de la empresa. <i style="color: orange;">Se recomienda el tamaño 300px x 300px</i></div>
                                <h6>Previsualización:</h6><img id="img-logo" src="{{ $configuracion->logo? $configuracion->logo : '/resources/img/default.jpg' }}" style="width:100px;" alt="Previsualización" class="img-fluid">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-10 offset-sm-1">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control form-control-round" name="gmaps" value="{{ $configuracion->gmaps }}">
