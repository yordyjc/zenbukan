                    ...
                    <div class="row">
                            ...
                            <div class="form-group {{ $errors->has('peso') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('peso') ? ' form-control-danger' : '' }}" id="peso" name="peso" value="{{ $periodo->peso }}" step="0.1" min="0">
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('presion') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-round {{ $errors->has('presion') ? ' form-control-danger' : '' }}" id="presion" name="presion" value="{{ $periodo->presion }}">
                                        <span class="input-group-append">
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('grasa') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('grasa') ? ' form-control-danger' : '' }}" id="grasa" name="grasa" value="{{ $periodo->grasa }}" step="0.01" min="0">
                                        <span class="input-group-append">
                         ...
                         <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('ritmo') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('ritmo') ? ' form-control-danger' : '' }}" id="ritmo" name="ritmo" value="{{ $periodo->ritmo }}" step="1" min="0">
                                        <span class="input-group-append">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('pecho') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('pecho') ? ' form-control-danger' : '' }}" id="pecho" name="pecho" value="{{ $periodo->pecho }}" step="0.1" min="0">
                                        <span class="input-group-append">
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('espalda') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('espalda') ? ' form-control-danger' : '' }}" id="espalda" name="espalda" value="{{ $periodo->espalda }}" step="0.1" min="0">
                                        <span class="input-group-append">
                                            <label class="input-group-text">cm.</label>
                                        </span>
                                    </div>
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('hombros') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('hombros') ? ' form-control-danger' : '' }}" id="hombros" name="hombros" value="{{ $periodo->hombros }}" step="0.1" min="0">
                                        <span class="input-group-append">
                                            <label class="input-group-text">cm.</label>
                                        </span>
                                    </div>
                         ...
                         <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('biceps') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('biceps') ? ' form-control-danger' : '' }}" id="biceps" name="biceps" value="{{ $periodo->biceps }}" step="0.1" min="0">
                                        <span class="input-group-append">
                                            <label class="input-group-text">cm.</label>
                                        </span>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('cintura') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('cintura') ? ' form-control-danger' : '' }}" id="cintura" name="cintura" value="{{ $periodo->cintura }}" step="0.1" min="0">
                                        <span class="input-group-append">
                                            <label class="input-group-text">cm.</label>
                                        </span>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('gluteos') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('gluteos') ? ' form-control-danger' : '' }}" id="gluteos" name="gluteos" value="{{ $periodo->gluteos }}" step="0.1" min="0">
                                        <span class="input-group-append">
                                            <label class="input-group-text">cm.</label>
                                        </span>
                                    </div>
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('pierna') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('pierna') ? ' form-control-danger' : '' }}" id="pierna" name="pierna" value="{{ $periodo->pierna }}" step="0.1" min="0">
                                        <span class="input-group-append">
                                            <label class="input-group-text">cm.</label>
                                        </span>
                                    </div>
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('pantorrilla') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group">
                                        <input type="number" class="form-control form-control-round {{ $errors->has('pantorrilla') ? ' form-control-danger' : '' }}" id="pantorrilla" name="pantorrilla" value="{{ $periodo->pantorrilla }}" step="0.1" min="0">
                                        <span class="input-group-append">
                                            <label class="input-group-text">cm.</label>
                                        </span>
                                    </div>
