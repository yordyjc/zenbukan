                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('triceps') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <input type="number" class="form-control form-control-round {{ $errors->has('triceps') ? ' form-control-danger' : '' }}" id="triceps" name="triceps" value="{{ old('triceps') }}" step="0.01" min="0">
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('subescapular') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <input type="number" class="form-control form-control-round {{ $errors->has('subescapular') ? ' form-control-danger' : '' }}" id="subescapular" name="subescapular" value="{{ old('subescapular') }}" step="0.01" min="0">
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('suprailiaco') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <input type="number" class="form-control form-control-round {{ $errors->has('suprailiaco') ? ' form-control-danger' : '' }}" id="suprailiaco" name="suprailiaco" value="{{ old('suprailiaco') }}" step="0.01" min="0">
                        ...
                        <div class="col-sm-12 col-xl-3">
                            <div class="form-group {{ $errors->has('abdominal') ? ' has-danger' : '' }} row">
                                ...
                                <div class="col-md-12">
                                    <input type="number" class="form-control form-control-round {{ $errors->has('abdominal') ? ' form-control-danger' : '' }}" id="abdominal" name="abdominal" value="{{ old('abdominal') }}" step="0.01" min="0">
