...
<head>
	...
	<title>Reestablecer contraseña - Fitness 10</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #ffffff;">
    ...
    <div style="display: none; font-size: 1px; line-height: 1px; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: sans-serif;">
    	Reestablece tu contraseña de Fitness 10
    </div>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 auto; background: #004A99;">
            	...
            	<tr>
            		<td style="padding: 20px 0; text-align: center">
            			<img src="{{ $configuracion->logo }}" width="60px" alt="Fitness 10" border="0" style="height: auto; background: #004A99; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #ffffff;">
            		</td>
            	</tr>
            	<!-- Email Header : END -->
                      	...
                      	<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                      		<tr>
                      			<td dir="ltr" style="padding: 0 10px 10px 10px;">
                      				<img src="https://img.icons8.com/wired/250/004A99/lock-2.png" width="200" height="" border="0" alt="Verificar cuenta" class="center-on-narrow" style="width: 100%; max-width: 200px; height: auto; background: #ffffff; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                      			</td>
                      		</tr>
                      	</table>
                      </div>
          		...
          		<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
          			<tr>
          				<td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
          					...
          					<p style="margin: 0 0 10px 0;">Atentamente,<br /><strong>El equipo de Fitness 10.</strong></p>
          				</td>
          			</tr>
          		</table>
          	</td>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 680px;">
        	<tr>
        		<td style="padding: 20px; font-family: sans-serif; font-size: 12px; line-height: 15px; text-align: center; color: #888888;">
        			&copy; fitness10salud.com<br><span class="unstyle-auto-detected-links">{{ $configuracion->direccion }}<br>{{ $configuracion->telefono }}</span>
        		</td>
        	</tr>
        </table>
        <!-- Email Footer : END -->
