            ...
            <div class="card-block">
                ...
                <div class="row">
                    <div class="col-sm-6 text-center">
                        ...
                        <br><br>
                        <form action="{{ url('/user/perfil-user') }}" method="post"  enctype="multipart/form-data">
                            <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <dl class="dl-horizontal row mt-2">
                            ...
                            <dd class="col-sm-9">{{ Auth::user()->sector_id }}</dd>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <a href="{{ url('/user/perfil-user/modificar') }}" class="btn waves-effect waves-light btn-primary btn-outline-primary btn-block mt-2">
...
<script>
    ...
    $("#password").keyup(function() {
        sendRequest("/user/perfil-user/confirmpass",'password='+$("#password").val(),'GET',function(data,textStatus){
            debugger;
            if(data.status==200){
                debugger;
    ...
    function change_password() {
        ...
        sendRequest("/user/perfil-user/changepass",$("#change-password").serialize(),'POST',function(data,textStatus){
            debugger;
            if(data.status==200){
                debugger;
